        ...
        return new Promise(resolve => {
            $({
                ...
                success: function (data) {
                    ...
                    else if (51 <= result.AQI && result.AQI <= 100) reply += '􂘁􀆊up􏿿2 普通 (' + result.AQI + '): 空氣品質普通，但對非常少數之極敏感族群產生輕微影響。';
                    ...
                    else if (65 <= result['PM2.5'] && result['PM2.5'] <= 70) reply += '􂘁􀆑.􏿿9 高 (' + result['PM2.5'] + ')';
